...
export { default as NewsNetworks } from './NewsNetworks';
...
export { default as PremiumNews } from './PremiumNews';
export { default as OrderServicesForm } from './OrderServicesForm';
